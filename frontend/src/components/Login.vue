            ...
            <div class="form-container sign-up">
                <form>
                    ...
                    <div class="social-icons">
                        <a href="#" class="google-icon"><Icon icon="mdi:google-plus" style="font-size: 20px; "/></a>
                        <a href="#" class="facebook-icon"><Icon icon="fe:facebook" style="font-size: 20px; "/></a>
                        <a href="#" class="git-icon"><Icon icon="mdi:github" style="font-size: 20px; "/></a>
                    </div>
